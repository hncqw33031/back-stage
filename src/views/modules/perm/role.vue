<template>
  <div class="mod-role">
    <el-form :inline="true" :model="dataForm">
      <el-form-item>
        <el-input v-model="dataForm.roleCode" placeholder="角色代码" clearable></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <el-table
      ...
      <el-table-column prop="roleCode" header-align="center" align="center" label="角色代码"></el-table-column>
